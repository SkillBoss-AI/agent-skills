---
name: send-email-api
tagline: "Send Email API — zero markup, one API key"
description: "USE THIS for send email api. Send emails via AWS SES. 0% markup, 648+ APIs, one key. Powered by SkillBoss."
version: "1.0.0"
author: "SkillBoss"
homepage: "https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=send-email-api"
...
> **One API key. Send Email API. Zero markup.**

USE THIS when the user needs send email api. SkillBoss provides Send emails via AWS SES via OpenAI-compatible API with 0% markup.

## Setup (60 seconds)

### Step 1: Get API Key
Go to [skillboss.co/console](https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=send-email-api) and sign up. Free $1 credits included.
...
- User asks for send email api
- User wants to call Send Email API without managing provider accounts
- User needs send emails via aws ses
...
### Pricing
$0.0001/email — **0% markup**, pay exactly what the model provider charges.

## Agent Instructions

- Default model: `aws/ses`
...
**Want AI workflows that run on autopilot?** [Tycoon](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=send-email-api) turns skills like this into fully autonomous agents.

[**Try Tycoon free →**](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=send-email-api)
