...
tagline: "Jina Reader API — zero markup, one API key"
description: "USE THIS for jina reader api. Jina AI web page extraction. 0% markup, 648+ APIs, one key. Powered by SkillBoss."
version: "1.0.0"
author: "SkillBoss"
homepage: "https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=jina-reader-api"
...
> **One API key. Jina Reader API. Zero markup.**

USE THIS when the user needs jina reader api. SkillBoss provides Jina AI web page extraction via OpenAI-compatible API with 0% markup.

## Setup (60 seconds)

### Step 1: Get API Key
Go to [skillboss.co/console](https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=jina-reader-api) and sign up. Free $1 credits included.
...
- User asks for jina reader api
- User wants to call Jina Reader API without managing provider accounts
- User needs jina ai web page extraction
...
### Pricing
$0.002/req — **0% markup**, pay exactly what the model provider charges.

## Agent Instructions

- Default model: `jina/reader`
...
**Want AI workflows that run on autopilot?** [Tycoon](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=jina-reader-api) turns skills like this into fully autonomous agents.

[**Try Tycoon free →**](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=jina-reader-api)
