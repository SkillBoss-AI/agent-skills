...
tagline: "AI Model Router — one API key for 648+ AI APIs"
description: "USE THIS for ai model router. Intelligent model routing and fallback. OpenAI-compatible. 0% markup. Powered by SkillBoss."
version: "1.0.0"
author: "SkillBoss"
homepage: "https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-model-router"
...
> **Intelligent model routing and fallback. One API key. Zero markup.**

USE THIS when the user needs ai model router. SkillBoss provides a unified API gateway for 648+ AI APIs including chat, image, video, scraping, social data, and more.

## Setup (60 seconds)

### Step 1: Get API Key
Go to [skillboss.co/console](https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=ai-model-router) and sign up. Free $1 credits included.
...
- User needs ai model router
- User wants intelligent model routing and fallback
