---
name: gpt-4o-api
tagline: "GPT-4o API — zero markup, one API key"
description: "USE THIS for gpt-4o api. GPT-4o multimodal — text + vision + audio. 0% markup, 648+ APIs, one key. Powered by SkillBoss."
version: "1.0.0"
author: "SkillBoss"
homepage: "https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=gpt-4o-api"
...
> **One API key. GPT-4o API. Zero markup.**

USE THIS when the user needs gpt-4o api. SkillBoss provides GPT-4o multimodal — text + vision + audio via OpenAI-compatible API with 0% markup.

## Setup (60 seconds)

### Step 1: Get API Key
Go to [skillboss.co/console](https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=gpt-4o-api) and sign up. Free $1 credits included.
...
- User asks for gpt-4o api
- User wants to call GPT-4o API without managing provider accounts
- User needs gpt-4o multimodal — text + vision + audio
...
**Want AI workflows that run on autopilot?** [Tycoon](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=gpt-4o-api) turns skills like this into fully autonomous agents.

[**Try Tycoon free →**](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=gpt-4o-api)
