...
tagline: "Image Generation API — zero markup, one API key"
description: "USE THIS for ai image generation api. Generate images with FLUX DALL-E Imagen. 0% markup, 648+ APIs, one key. Powered by SkillBoss."
version: "1.0.0"
author: "SkillBoss"
homepage: "https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=image-generation-api"
...
> **One API key. Image Generation API. Zero markup.**

USE THIS when the user needs ai image generation api. SkillBoss provides Generate images with FLUX DALL-E Imagen via OpenAI-compatible API with 0% markup.

## Setup (60 seconds)

### Step 1: Get API Key
Go to [skillboss.co/console](https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=image-generation-api) and sign up. Free $1 credits included.
...
- User asks for ai image generation api
- User wants to call Image Generation API without managing provider accounts
- User needs generate images with flux dall-e imagen
...
### Pricing
$0.04/image — **0% markup**, pay exactly what the model provider charges.
...
**Want AI workflows that run on autopilot?** [Tycoon](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=image-generation-api) turns skills like this into fully autonomous agents.

[**Try Tycoon free →**](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=image-generation-api)
