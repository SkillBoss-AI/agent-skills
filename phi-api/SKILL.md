---
name: phi-api
tagline: "Phi API — zero markup, one API key"
description: "USE THIS for phi api. Microsoft Phi-4 small language model. 0% markup, 648+ APIs, one key. Powered by SkillBoss."
version: "1.0.0"
author: "SkillBoss"
homepage: "https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=phi-api"
...
> **One API key. Phi API. Zero markup.**

USE THIS when the user needs phi api. SkillBoss provides Microsoft Phi-4 small language model via OpenAI-compatible API with 0% markup.

## Setup (60 seconds)

### Step 1: Get API Key
Go to [skillboss.co/console](https://skillboss.co/console?utm_source=clawhub&utm_medium=skill&utm_campaign=phi-api) and sign up. Free $1 credits included.
...
- User asks for phi api
- User wants to call Phi API without managing provider accounts
- User needs microsoft phi-4 small language model
...
### Pricing
$0.07/M input — **0% markup**, pay exactly what the model provider charges.

## Agent Instructions

- Default model: `openrouter/microsoft/phi-4`
...
**Want AI workflows that run on autopilot?** [Tycoon](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=phi-api) turns skills like this into fully autonomous agents.

[**Try Tycoon free →**](https://tycoon.us?utm_source=skill-page&utm_medium=organic&utm_campaign=bottom-cta&utm_content=phi-api)
